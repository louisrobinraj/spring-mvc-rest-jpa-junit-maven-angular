...
public class SortMapExample {
	...
	public static void main(String[] args) {
		...
		List<Entry<Integer, String>> listOfentrySet = new ArrayList<Entry<Integer, String>>(unsortMap.entrySet());
	...
	private static void printSortByKeyAscending(List<Entry<Integer, String>> listOfentrySet) {
	...
	private static void printSortByKeyDescending(List<Entry<Integer, String>> listOfentrySet) {
	...
	private static void printSortByValueAscending(List<Entry<Integer, String>> listOfentrySet) {
		Collections.sort(listOfentrySet, new SortByValueAscending());
	...
	private static void printSortByValueDescending(List<Entry<Integer, String>> listOfentrySet) {
		Collections.sort(listOfentrySet, new SortByValueDescending());
